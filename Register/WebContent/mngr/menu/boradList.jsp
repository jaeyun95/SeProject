		...
		<tbody>
			<c:forEach items="${borads}" var="board"><!--//var 값확인 필요  -->
				<tr>
					...
					<td><a href="UserController?action=edit&boardId=<c:out value="${board.boardId}"/>">수정</a></td>
					<td><a href="UserController?action=delete&boardId=<c:out value="${board.boardId}"/>">삭제</a></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
	<p>
		<a href="UserController?action=insert">게시판 추가</a>
	</p>
</body>
</html>